...
app.secret_key = "asoconnect_chave_secreta_2026"
...
def login():
    ...
    if request.method == "POST":
        ...
        id_empresa = request.form.get("codigo_empresa")
        id_funcionario = request.form.get("codigo")
        ...
        cursor.execute("""
            ...
            WHERE f.ID_empresa = %s
              AND f.ID_Funcionarios = %s
              AND f.Condicao = 'ATIVO'
        ...
        if usuario:
            ...
            session["id_funcionario"] = usuario["ID_Funcionarios"]
        ...
        return render_template(
            "login.html",
            erro="Código da empresa ou código de acesso inválido."
        )
    ...
    if request.method == "POST":
        ...
        return render_template(
            "login.html",
            erro="Código da empresa, código de acesso ou senha inválidos."
        )
...
def dashboard():
    ...
    return render_template(
        ...
        asos_ativos=asos_ativos,
        asos_vencendo=asos_vencendo,
        asos_vencidos=asos_vencidos,
        lista_asos=lista_asos,
        pagina=pagina,
